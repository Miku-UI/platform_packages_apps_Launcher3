 ...
 *                     for the taskbar create/recreate process.
    ...
    public boolean isTinyTaskbar() {
        return mDeviceProfile.enableTinyTaskbar() && mDeviceProfile.getDeviceProperties().isPhone() && mDeviceProfile.isTaskbarPresent;
    }
    ...
    public int getDefaultTaskbarWindowSize() {
        ...
        if (isGestureNav() && !SettingsCache.INSTANCE.get(this).getValue(NAVIGATION_BAR_HINT)) {
            return 0;
        }
